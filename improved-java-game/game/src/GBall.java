public class GBall extends GameMovableElementAdapter
{
	...
	public static void setNumBall(int numBall) {
		NumBall = numBall;
	}
	...
	protected void CollideDownBorder()
	{
		if (this.getID() == 2) {
			...
			if(NumBall>1) {
				GGame.replaceEntityByEntityArray(NumBall, NumBall+1);
			}
			else
				GGame.DecreaseLive();
		}
			...
			NumBall--;
			GGame.deleteEntityByEntityArray(this.getID());
		}
	}
